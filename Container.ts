...
export default class container
{
    ...
    main_component_object:main_components;

    

    constructor(place,x,text,timeline,timer,deadline_timer,main_component_object)
    {
        this.place=place;
        this.input_date=x;
    ...
    making_elements():void
    {
        ...
        let obj=new display_date_time();
        let d1=obj.display_date_time(this.input_date);
        ...
        self.xx=setInterval(function() {
            ...
            if (distance < 0) 
            {
                if(self.timeline=="future")
                {
                    ...
                    let index = self.main_component_object.future_array.indexOf(self);
