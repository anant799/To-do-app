function display_date_tim(x:string):string
    {
        //console.log("yes");
        let y=x.split('-');
        let ans="";
...
class container
{
    ...
    timeline: string;
    timer: number;
    deadline_timer: number;
    list: cell[];
    thumbs_up_div: HTMLDivElement;
    div1: HTMLDivElement;
    button: HTMLButtonElement;
    completed_button: HTMLButtonElement;
    input: HTMLInputElement;
    div: HTMLDivElement;
    h2: HTMLHeadingElement;
    timer_div: HTMLDivElement;
    date_time_div: HTMLDivElement;
    completed_button_div: HTMLDivElement;
    thumbsdown: HTMLElement;
    thumbsup: HTMLElement;
...
// main
let div_left:HTMLElement=document.getElementById("div_present");
let div_right:HTMLElement=document.getElementById("div_past");
let div_middle=document.getElementById("div_future");
let root=document.getElementById('root');
// for timer
let start_time=document.getElementById("timer_start_time") as HTMLInputElement;
let deadline_time=document.getElementById("timer_time") as HTMLInputElement;


let date_field_js=document.getElementById("date_field") as HTMLInputElement;
let text_field_js=document.getElementById("text_field") as HTMLInputElement;
let button_field_js:HTMLElement=document.getElementById("date_button");

let present_array:container[]=[]
let past_array:container[]=[]
let future_array:container[]=[]

button_field_js.addEventListener("click",func_main_1);

function func_main_1():void{
